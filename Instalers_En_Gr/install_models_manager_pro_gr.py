...
MESSAGES.update({'user_site_mode': 'Δεν υπάρχουν δικαιώματα διαχειριστή και δεν χρησιμοποιείται virtual environment. Οι εγκαταστάσεις pip θα γίνουν με --user χωρίς απόπειρα απεγκατάστασης global packages.', 'global_mode': 'Θα χρησιμοποιηθεί κανονική εγκατάσταση pip στο ενεργό περιβάλλον Python.', 'skip_uninstall_user_mode': 'Παραλείπεται το pip uninstall επειδή το script τρέχει σε λειτουργία --user και δεν είναι ασφαλές να αφαιρεθούν global packages από το Program Files χωρίς δικαιώματα διαχειριστή.', 'cmake_msi_fallback': 'Η εγκατάσταση του CMake μέσω MSI δεν ολοκληρώθηκε καθαρά. Θα χρησιμοποιηθεί φορητή ZIP έκδοση ως fallback.', 'cmake_zip_downloading': 'Γίνεται λήψη του CMake ZIP από την επίσημη πηγή έκδοσης...', 'cmake_zip_downloaded': 'Το CMake ZIP αποθηκεύτηκε στο: {path}', 'cmake_portable_ready': 'Η φορητή έκδοση του CMake είναι έτοιμη στο: {path}', 'cmake_user_path_persisted': 'Το CMake προστέθηκε και στο user PATH των Windows.', 'cmake_user_path_failed': 'Δεν ήταν δυνατό να ενημερωθεί το user PATH των Windows: {error}', 'torch_reuse': 'Βρέθηκε ήδη λειτουργικό torch/torchvision ({version}). Θα χρησιμοποιηθούν όπως είναι και δεν θα γίνει επανεγκατάσταση.', 'torch_reuse_gpu': 'Βρέθηκε ήδη λειτουργικό GPU-enabled torch/torchvision ({version}) με torch.cuda.is_available()=True. Παραλείπεται η επανεγκατάσταση.', 'torch_existing_not_usable': 'Βρέθηκε εγκατεστημένο torch/torchvision, αλλά δεν ταιριάζει με το ζητούμενο mode ({variant}). Θα γίνει εγκατάσταση κατάλληλης έκδοσης.'})
